...
int main(void)
{
	...
	TIM4->CR1 |= TIM_CR1_CEN | TIM_CR1_DIR;	  	//Enable Timer and down counting
	//----------------------------------------------------------------------
